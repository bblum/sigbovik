...
%\ref{fig:4}
4
shows what the other heads hear if the controlling head says whatever he wants, which we'll say are $x$, $y$, and $z$, because they can all be different.
...
The Spoken Words plan and the Signed Letters plan need you to send up to $(n-1)$ times $(n-2)$ times $(n-m-1)$ letters or words. You can make the number of different times you need to send lower by putting letters or words together and sending them at the same time.
...
One such way is to suppose that a computer may stop responding but will never respond with something wrong.
However, when you need to trust your computers very very much, you can't suppose that sort of thing, and you need to spend all time and space it takes to solve the \prob.
