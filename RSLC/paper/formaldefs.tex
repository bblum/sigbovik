...
\newcommand{\SubstLam}{
	\inferrule[Subst-Lam]{
		...
		\subst{e_0}{x} \lambda y.e = \lambda y.\subst{e_0}{x}e'
	}
}
\newcommand{\SubstLamCapture}{
	\inferrule[Subst-Lam-Capture]{
	}{
		\subst{e_0}{x} \lambda x.e = \lambda x.\capture{e_0}{x}e
	}
}
\newcommand{\SubstApp}{
	\inferrule[Subst-App]{
	}{
		\subst{e_0}{x} e_1 e_2 = \subst{e_0}{x}e_1 \subst{e_0}{x} e_2'
	}
}
\newcommand{\SubstVarY}{
	\inferrule[Subst-Var-Y]{
		...
		\subst{e_0}{x} y[\rep{e}] = y[\subst{e_0}{x}\rep{e}]
	}
}
\newcommand{\SubstVarX}{
	\inferrule[Subst-Var-X]{
		...
		\subst{e_0}{x} x[\rep{e}] = e_1
	}
}
\newcommand{\SubstZero}{
	\inferrule[Subst-Zero]{
	}{
		\subst{e_0}{x} \Zero = \Zero
	}
}
\newcommand{\SubstSuc}{
	\inferrule[Subst-Suc]{
	}{
		\subst{e_0}{x} \Suc{e} = \Suc{\subst{e_0}{x}e}
	}
}
\newcommand{\SubstCaseCapture}{
	\inferrule[Subst-Case-Capture]{
	}{
		\subst{e_0}{x} \Case{e_1}{e_2}{x}{e_3} = \Case{\subst{e_0}{x}e_1}{\subst{e_0}{x}e_2}{x}{\capture{e_0}{x}e_3}
	}
}
\newcommand{\SubstCase}{
	\inferrule[Subst-Case]{
		...
		\subst{e_0}{x} \Case{e_1}{e_2}{y}{e_3} = \Case{\subst{e_0}{x}e_1}{\subst{e_0}{x}e_2}{y}{\subst{e_0}{x}e_3}
	}
}
\newcommand{\SubstLetCapture}{
	\inferrule[Subst-Let-Capture]{
	}{
		\subst{e_0}{x} \Let{x}{e_1}{e_2} = \Let{x}{\subst{e_0}{x}e_1}{\capture{e_0}{x}e_2}
	}
}
\newcommand{\SubstLet}{
	\inferrule[Subst-Let]{
		...
		\subst{e_0}{x} \Let{y}{e_1}{e_2} = \Let{y}{\subst{e_0}{x}e_1}{\subst{e_0}{x}e_2}
	}
}
...
\newcommand{\CaptureLam}{
	\inferrule[Capture-Lam]{
		...
		\capture{e_0}{x} \lambda y.e = \lambda y.\capture{e_0}{x}e'
	}
}
\newcommand{\CaptureApp}{
	\inferrule[Capture-App]{
	}{
		\capture{e_0}{x} e_1 e_2 = \capture{e_0}{x}e_1 \capture{e_0}{x} e_2'
	}
}
\newcommand{\CaptureVarY}{
	\inferrule[Capture-Var-Y]{
		...
		\capture{e_0}{x} y[\rep{e}] = y[\capture{e_0}{x}\rep{e}]
	}
}
\newcommand{\CaptureVarX}{
	\inferrule[Capture-Var-X]{
	}{
		\capture{e_0}{x} x[\rep{e}] = x[e_0,\capture{e_0}{x}\rep{e}]
	}
}
\newcommand{\CaptureZero}{
	\inferrule[Capture-Zero]{
	}{
		\capture{e_0}{x} \Zero = \Zero
	}
}
\newcommand{\CaptureSuc}{
	\inferrule[Capture-Suc]{
	}{
		\capture{e_0}{x} \Suc{e} = \Suc{\capture{e_0}{x}e}
	}
}
\newcommand{\CaptureCase}{
	\inferrule[Capture-Case]{
	}{
		\capture{e_0}{x} \Case{e_1}{e_2}{y}{e_3} = \Case{\capture{e_0}{x}e_1}{\capture{e_0}{x}e_2}{y}{\capture{e_0}{x}e_3}
	}
}
\newcommand{\CaptureLet}{
	\inferrule[Capture-Let]{
	}{
		\capture{e_0}{x} \Let{y}{e_1}{e_2} = \Let{y}{\capture{e_0}{x}e_1}{\capture{e_0}{x}e_2}
	}
}
