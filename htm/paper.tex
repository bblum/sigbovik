...
Of these, Landslide uses Dynamic Partial Order Reduction \cite{dpor} to prune its state spaces.
...
Let $I = TN_1@L_1, TN_2@L_2, ... TN_n@L_n$,
...
\newcommand\ti{\ensuremath{\hilight{lavender}{\mathbf{T1}}}}
\newcommand\tj{\ensuremath{\hilight{seafoam}{\mathbf{T2}}}}
\newcommand\tk{\ensuremath{\hilight{salmon}{\mathbf{T3}}}}
...
can be thusly separated with conflicting accesses interleaved in between,
...
{\bf Modeling transaction failure.}
