...
\begin{table*}[t]
	...
	\begin{tabular}{cc||r|r|r||r|r|r|r}
		...
		\bf buggy test	& \bf params&\cpu{\bf cputime}&\wtm{\bf walltime}&\ints{\bf int's}&\cpu{\bf cputime}&\wtm{\bf walltime}&\ints{\bf int's}& \ETA{\bf SS size (est.)} \\
		\hline
		\hline
		{\tt htm1}
