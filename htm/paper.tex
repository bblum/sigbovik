...
larger tests we were unable to complete before the submission deadline,
each given a timeout of 1 hour. % TODO: ??
Their completion times are listed as {\em unk.}
and their listed state space sizes represent Landslide's estimate at the moment of timeout.
...
\begin{table}[h]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Transactional tests verified by Landslide.}
	\label{tab:verifs}
\end{table}
...
on {\tt map\_basic}(2,1) reduced its 28635 interleavings to 11577.
