...
Most well-known pack series from the ITG community are included, such as {\em Cirque}, {\em ITG}, {\em Mute Sims}, {\em Pendulum}, {\em r21*}, {\em SPEEDCOOOORE}, {\em The Legend of Zim}, {\em Valex's Magical 4-Arrow Adventure}, and {\em Oh Henry! Mad Stamina: Streamy $\cdot$ Brutal $\cdot$ Stamina Bar in Milk Chocolate}.
...
\begin{figure}[h]
	...
	\end{center}
	\caption{We employ the techniques of \cite{deltax} for ITG machine translation.} %All photos credit \cite{alanv}.
